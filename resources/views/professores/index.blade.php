...
<div class="card mt-5">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col">
                <a class="btn btn-success float-end" href="{{ url('/professores/novo') }}">Cadastrar</a>
            </div>
        </div>
            ...
            <div class="col">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" href="{{ url('/professores/editar', ['id' => $professor['id']]) }}">Editar</a>
                            <a onclick="atualizaHref(this)" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-danger" href="{{ url('/professores/delete', ['id' => $professor['id']]) }}">Excluir</a>
                        </td>
                    </tr>
                    @endforeach
                    <tr>
